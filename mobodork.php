...
print "                 _                 _            _   \n"; 
print "                | |               | |          | |   \n";
print " _ __ ___   ___ | |__   ___     __| | ___  _ __| | __\n";
print "| '_ ` _ \ / _ \| '_ \ / _ \   / _` |/ _ \| '__| |/ /\n";
print "| | | | | | (_) | |_) | (_) | | (_| | (_) | |  |   < \n";
print "|_| |_| |_|\___/|_.__/ \___/   \__,_|\___/|_|  |_|\_\.\n";
print "                                                     \n";
print "by mobodigital.id\n\n";
    }
    banner();
    ...
    while(true){
        ...
        $url = "https://cse.google.com/cse/element/v1?rsz=".$rsz[1]."&num=100&&start=".$i."&hl=en&source=gcsc&gss=.com&cselibv=".$csiLib[1]."&cx=".$cx[1]."&q=".rawurlencode($dork)."&safe=off&cse_tok=".$cseToken[1]."&exp=".$exp[1].",".$exp[2]."&callback=google.search.cse.api16950";
